...
##############################################
    ...
    X_embedding_filename = args.embedding_data_path + args.data_name + '/'+ args.data_name+ '_cellchat_nichenet_threshold_distance_bothAbove_cell98th_tanh_3dim_r1_Embed_X.npy' 
...
#####################
    ...
    toomanycells_input_filename =  args.embedding_data_path +'/'+ args.data_name +'/' + args.data_name +'_r1_node_embedding_ccc.csv'
